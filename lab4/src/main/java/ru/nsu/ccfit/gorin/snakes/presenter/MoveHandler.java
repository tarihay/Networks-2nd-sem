package ru.nsu.ccfit.gorin.snakes.presenter;

import javafx.scene.paint.Color;
import org.jetbrains.annotations.NotNull;
import ru.nsu.ccfit.gorin.snakes.config.Config;
import ru.nsu.ccfit.gorin.snakes.game.GameObserver;
...
import ru.nsu.ccfit.gorin.snakes.game.player.PlayerWithScore;
import ru.nsu.ccfit.gorin.snakes.game.snake.SnakeInfo;
import ru.nsu.ccfit.gorin.snakes.presenter.event.JoinToGameEvent;
import ru.nsu.ccfit.gorin.snakes.presenter.event.MoveEvent;
import ru.nsu.ccfit.gorin.snakes.presenter.event.UserEventType;
import ru.nsu.ccfit.gorin.snakes.gui.controllers.View;
import ru.nsu.ccfit.gorin.snakes.gui.utils.GameInfoWithButton;
import ru.nsu.ccfit.gorin.snakes.gui.utils.PlayerColorMapper;
import ru.nsu.ccfit.gorin.snakes.net.MainNodeHandler;
import ru.nsu.ccfit.gorin.snakes.net.gamelistchecker.GameInfo;
import ru.nsu.ccfit.gorin.snakes.net.gamelistchecker.GameListObserver;
import ru.nsu.ccfit.gorin.snakes.net.node.Role;
import ru.nsu.ccfit.gorin.snakes.presenter.event.UserEvent;
